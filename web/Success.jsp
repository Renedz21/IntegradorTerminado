<%-- 
    Document   : Success
    Created on : 22/06/2021, 09:17:48 PM
    Author     : Microsoft
--%>
...
<html>
    ...
    <body>
        ...
        <div class="alert alert-success container mt-5 text-center" role="alert" id="alerta">
            <h4 class="alert-heading">Compra generada con exito!<br><a href="Inicio.jsp">Volver al inicio</a></h4>
        </div>
